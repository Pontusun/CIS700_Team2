...
if("TRUE" STREQUAL "TRUE")
  set(face_recognition_SOURCE_PREFIX /home/genesis/code/ROS/catkin_ws/src/vision/face_recognition)
  set(face_recognition_DEVEL_PREFIX /home/genesis/code/ROS/catkin_ws/devel)
  ...
  set(face_recognition_INSTALL_PREFIX /home/genesis/code/ROS/catkin_ws/install)
...
if(NOT "/home/genesis/code/ROS/catkin_ws/devel/include " STREQUAL " ")
  set(face_recognition_INCLUDE_DIRS "")
  set(_include_dirs "/home/genesis/code/ROS/catkin_ws/devel/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'face_recognition' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'team2 <parallels@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'face_recognition' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/genesis/code/ROS/catkin_ws/src/vision/face_recognition/${idir}'.  Ask the maintainer 'team2 <parallels@todo.todo>' to fix it.")
    endif()
